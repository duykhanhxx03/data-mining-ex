...
tạo ra \FnCount{} false negative (\FnRate{} của $n$). Kết luận: dùng BF cho tập gần như tĩnh; dùng CBF khi cần xóa động
...
hệ số tải vượt $\sim$95\%. \textbf{d-left CBF} (dlCBF)~\cite{bonomi2006}: dùng
...
khi có nguồn dữ liệu chuẩn cho delete; và Cuckoo Filter đáng khảo sát khi cần xóa
...
có khóa. Các số bộ nhớ chỉ là payload của mảng backing, không phải RSS.
